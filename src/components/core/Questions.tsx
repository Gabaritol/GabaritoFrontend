    ...
    const faqs = [
        {
            ...
            answer: "QUESTÕES BÁSICAS DA BANCA ESCOLHIDA, GABARITO SIMPLES E INDICAÇÃO DE DIFICULDADE. TUDO GERADO PELO NOSSO MOTOR EM MENOS DE 30 SEGUNDOS.",
        },
        {
            question: "COMO FUNCIONA A GERAÇÃO PAGA (PRO)?",
            answer: "ALÉM DO GABARITO, VOCÊ RECEBE UMA EXPLICAÇÃO DETALHADA DE CADA ALTERNATIVA, REVISÃO POR IA E OPÇÃO DE EXPORTAR A PROVA FORMATADA EM PDF.",
        },
        {
            question: "E SE AS QUESTÕES FOREM REPETIDAS OU RUINS?",
            answer: "NOSSO MOTOR GARANTE CONTEÚDO INÉDITO BASEADO NOS PADRÕES DAS BANCAS. SE DETECTAR PROBLEMAS, SEUS CRÉDITOS SÃO DEVOLVIDOS. SEM PERGUNTAS.",
        },
        {
            question: "VOCÊS COBRAM ASSINATURA MENSAL?",
            answer: "NÃO. VOCÊ PAGA APENAS PELOS CRÉDITOS QUE UTILIZAR, NO MODELO PAY-AS-YOU-GO. NADA DE COBRANÇAS SURPRESAS NO SEU CARTÃO.",
        },
        {
            question: "MEUS CRÉDITOS EXPIRAM?",
            answer: "NÃO, SEUS CRÉDITOS NUNCA EXPIRAM. ELES FICAM VINCULADOS À SUA CONTA PARA SEMPRE ATÉ SEREM TOTALMENTE UTILIZADOS.",
        },
        {
            question: "FUNCIONA PARA VAGAS E PROVAS EM INGLÊS?",
            answer: "SIM. NOSSA IA DETECTA O IDIOMA DO SEU PROMPT E GERA AS QUESTÕES COM BASE NO CONTEXTO E TERMINOLOGIA TÉCNICA CORRETA NO IDIOMA SOLICITADO.",
        },
    ];
