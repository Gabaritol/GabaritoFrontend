...
export default function Main() {
    return (
        <main
            className="min-h-screen bg-[#141414] text-[#e5e5e5] font-mono 
    px-4 sm:px-6 lg:px-8 py-8 md:py-12 max-w-7xl mx-auto selection:bg-amber-500 selection:text-black"
        >
                ...
                <div className="lg:col-span-7 flex flex-col gap-6">
                    ...
                    <FadeUp delay={100}>
                        <p className="DepartureMono text-xs md:text-sm text-[#a3a3a3] uppercase tracking-wider max-w-xl leading-relaxed">
                            Gere folhas de respostas inteligentes, escaneie
                            cartões e valide dados com precisão cirúrgica de um
                            sistema automatizado de alta performance.
                        </p>
                    </FadeUp>
                    ...
                    <FadeUp delay={100}>
                        <div className="DepartureMono mt-4 pt-8 border-t border-[#262626] flex flex-wrap gap-4 sm:gap-8 text-[11px] font-bold uppercase tracking-wider text-[#737373]">
                            ...
                            <div>
                                <span className="text-amber-500">99.8%</span> DE
                                PRECISÃO
                            </div>
                        </div>
                    </FadeUp>
                    ...
                    <div className="DepartureMono bg-[#1a1a1a] border border-[#262626] p-4 flex flex-col gap-4 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="flex items-start gap-4 p-4 bg-[#212121] border border-[#2d2d2d] rounded-sm">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <p className="text-[11px] text-[#a3a3a3] uppercase leading-normal">
                                    O cartão-resposta foi escaneado e validado
                                    com sucesso pelo sistema do Gabaritol.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="border-t border-[#262626] pt-4 mt-2 text-center">
                            <div className="text-2xl sm:text-3xl font-black tracking-widest text-white uppercase opacity-90">
                                NOTA:{" "}
                                <span className="text-amber-500">10.0</span>
                            </div>
                        </div>
                    </div>
                </FadeUp>
                ...
                <FadeUp delay={1} className="lg:col-span-5">
                    <div className="bg-[#1a1a1a] border border-[#262626] p-6 font-mono text-xs">
                        <div className="text-[#737373] uppercase tracking-widest text-[10px] mb-4 flex items-center gap-2">
                            <span className="text-red-500">■</span> ANÁLISE DE
                            FALHAS — CORREÇÃO MANUAL
                        </div>
                ...
                <FadeUp delay={150} className="lg:col-span-7">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-xs md:text-sm text-[#a3a3a3] uppercase tracking-wider leading-relaxed max-w-xl">
                            Corrigir dezenas de cartões de resposta manualmente
                            gera cansaço físico, erros de digitação e notas
                            injustas. Planilhas, papel rasurado e caneta
                            vermelha só quebram o fluxo da sua instituição.
                        </p>
                    </div>
                </FadeUp>
            </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <FadeUp delay={1}>
                        <div className="bg-[#1a1a1a] border border-[#262626] p-6 flex flex-col gap-4 hover:border-amber-500/30 transition-colors h-full">
                            ...
                            <p className="text-[11px] text-[#a3a3a3] uppercase leading-normal">
                                Escaneie folhas de respostas pela webcam ou
                                celular. O resultado sai em menos de 30
                                segundos.
                            </p>
                        </div>
                    </FadeUp>
                    ...
                    <FadeUp delay={150}>
                        <div className="bg-[#1a1a1a] border border-[#262626] p-6 flex flex-col gap-4 hover:border-amber-500/30 transition-colors h-full">
                            ...
                            <p className="text-[11px] text-[#a3a3a3] uppercase leading-normal">
                                Crie cartões de resposta customizados em PDF
                                prontos para impressão em segundos.
                            </p>
                        </div>
                    </FadeUp>
                    ...
                    <FadeUp delay={100}>
                        <div className="bg-[#1a1a1a] border border-[#262626] p-6 flex flex-col gap-4 hover:border-amber-500/30 transition-colors relative h-full">
                            ...
                            <p className="text-[11px] text-[#a3a3a3] uppercase leading-normal">
                                Vincule os resultados diretamente com sistemas
                                escolares ou planilhas Excel sem digitar nada.
                            </p>
                        </div>
                    </FadeUp>
                </div>
                ...
                <FadeUp>
                    <div className="text-center flex flex-col gap-2">
                        ...
                        <p className="text-[11px] text-[#a3a3a3] max-w-lg mx-auto uppercase tracking-wider leading-relaxed">
                            Todas as marcações calculadas em milissegundos com
                            um único propósito: garantir precisão absoluta na
                            nota.
                        </p>
                    </div>
                </FadeUp>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-6">
                    <FadeUp delay={1}>
                        <div className="p-4 border-l-2 border-[#262626] hover:border-amber-500 transition-colors">
                            ...
                            <p className="text-[10px] text-[#a3a3a3] uppercase mt-1">
                                Lê a imagem enviada, alinha as bordas e calibra
                                os eixos da folha.
                            </p>
                        </div>
                    </FadeUp>
                    <FadeUp delay={150}>
                        <div className="p-4 border-l-2 border-[#262626] hover:border-amber-500 transition-colors">
                            ...
                            <p className="text-[10px] text-[#a3a3a3] uppercase mt-1">
                                Detecta a intensidade do grafite ou caneta nas
                                bolhas marcadas.
                            </p>
                        </div>
                    </FadeUp>
                    <FadeUp delay={100}>
                        <div className="p-4 border-l-2 border-[#262626] hover:border-amber-500 transition-colors">
                            ...
                            <p className="text-[10px] text-[#a3a3a3] uppercase mt-1">
                                Cruza os dados com o gabarito oficial e gera
                                logs de erros duplos.
                            </p>
                        </div>
                    </FadeUp>
                </div>
                    ...
                    <div className="w-full bg-[#1a1a1a] border border-[#262626] p-4 text-[11px] font-mono text-[#a3a3a3]">
                        ...
                        <div className="flex flex-col gap-2 uppercase tracking-wide">
                            <div className="flex flex-col sm:flex-row sm:items-baseline gap-0.5 sm:gap-12">
                                ...
                                <span>
                                    Mapeamento dos vértices da folha concluído
                                    com sucesso.
                                </span>
                            </div>
                            <div className="flex flex-col sm:flex-row sm:items-baseline gap-0.5 sm:gap-12">
                                ...
                                <span>
                                    Nenhuma dupla marcação ou rasura detectada
                                    nas questões.
                                </span>
                            </div>
                            <div className="flex flex-col sm:flex-row sm:items-baseline gap-0.5 sm:gap-12">
                                ...
                                <span>
                                    Acurácia de detecção do preenchimento:
                                    99.94%
                                </span>
                            </div>
